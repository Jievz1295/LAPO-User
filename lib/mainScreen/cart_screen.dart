...
import 'package:lapo_user/widgets/cart_items_design.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          "LAPO",
          style: TextStyle(fontSize: 45, fontFamily: "Signatra", color: Colors.white),
        ),
        centerTitle: true,
              ...
              return Padding(
                ...
                child: Center(
                  child: cartProvider.count == 0
                      ? Container()
                      : Text(
                          "Total Price: RM " + amountProvider.tAmount.toString(),
